...
ACTIVATIONURL='dsm://10.217.139.48:4120/'
MANAGERURL='https://10.217.139.48:4119'
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "policyid:10"
# /opt/ds_agent/dsa_control -a dsm://10.217.139.48:4120/ "policyid:10"